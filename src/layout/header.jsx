...
const Header = () => {
    ...
    const {SetSearchKeyword,SearchKeyword,ListByKeywordRequest}=ProductStore();
            ...
            <nav className="navbar  sticky-top bg-white navbar-expand-lg navbar-light py-3">
                <div className="container">
                    ...
                    <div className=" d-lg-flex">
                        ...
                        {
                            isLogin()?(
                                <button type="button" className="btn ms-3 btn-success d-flex"  onClick={onLogOut}>Logout</button>
                            ):(<>
                                    <Link type="button" className="btn ms-3 btn-success d-flex" to="/login">Login</Link>
                                    <Link type="button" className="btn ms-3 btn-success d-flex" to="/registration">Registration</Link>
                                </>
